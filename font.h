...
#define FONT_H_
		 ...
		 * 
		 * @details
		 * When this macro is defined, font data is saved in the EEPROM memory, which helps reduce PROGMEM usage.
		 * The amount of EEPROM required depends on the character set:
		 ...
		 * 
		 * @note Using EEPROM for font storage extends PROGMEM availability but be mindful of EEPROM write limits.
		 */
	...
	#ifndef FONT_STORE_IN_EEPROM
		#ifndef FONT_STORE_IN_PROGMEM
			/**
			 * @def FONT_STORE_IN_PROGMEM
			 * @brief Stores the font data in PROGMEM memory.
			 * 
			 * @details
			 * When this macro is defined, font data is saved in the PROGMEM memory instead of EEPROM.
			 * The amount of PROGMEM required depends on the character set:
			 * - All ASCII characters require approximately 470 bytes of PROGMEM.
			 * - ASCII characters without lowercase letters require approximately 340 bytes of PROGMEM.
			 * 
			 * @note Using PROGMEM for font storage extends EEPROM availability.
			 */
			// #define FONT_STORE_IN_PROGMEM
		#endif
	#endif
